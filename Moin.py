...
# Bot Configuration
TELEGRAM_BOT_TOKEN = '7799579745:AAEBe-b42-FYeqegBVQs7KYJ8celqUUowvI'
ADMIN_USER_ID = 7442822303# Replace with your admin user ID
ADMIN_USERNAME = 'Death Not pro hack😈'  # Replace with your admin's Telegram username (without @)

# Customizable messages
OWNER_NAME = '@Asgafsfs99_bot'  # Change this to the owner's name
WELCOME_MESSAGE = (
